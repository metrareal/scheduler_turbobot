...
```bash
git clone https://github.com/metrareal/scheduler_turbobot.git
cd scheduler_turbobot
````
...
Этот проект распространяется под лицензией MIT. Лицензия MIT (англ. MIT License) — лицензия свободного программного обеспечения, разработанная Массачусетским технологическим институтом.
